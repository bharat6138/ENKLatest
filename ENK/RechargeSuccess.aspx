<%@ Page Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="RechargeSuccess.aspx.cs" Inherits="ENK.RechargeSuccess" %>
                                                 ...
                                                 <div id="divprint"  class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <div id="divDistributor" style="border: 2px solid rgb(109, 126, 247);" runat="server" class="col-xs-12 col-sm-6 col-md-6 col-lg-6"> 
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                                  
                                                            ...
                                                            <%--add by akash starts--%>
                                                            <span style="color:red;" ><strong>Note:-</strong> If you have any issue in transaction, then call for assistance :<br /> <strong><%= ConfigurationManager.AppSettings["COMPANY_PHONE"] %></strong> & Email : <strong><%= ConfigurationManager.AppSettings["COMPANY_EMAIL"] %></strong></span> 
                                                            <%--add by akash ends--%>
                                                        </div>
                                                 ...
                                                 <div id="divBtn" runat="server" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6"> 
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                            ...
                                                            <asp:HyperLink ID="HyperLink1" NavigateUrl="~/Topup.aspx" Class="pull-right" runat="server">Back to Topup</asp:HyperLink>
                                                        </div>
