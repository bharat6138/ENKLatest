    ...
    public partial class TopupReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                DataSet ds = ssc.GetReportTopup(distributorID, ClientTypeID, LoginID, FromDate, ToDate);
        ...
        protected void btnGet_Click(object sender, EventArgs e)
        {
            ...
            if (txtFromDate.Text.Trim() == "" && txtToDate.Text.Trim() == "")
            {
                ...
                DataSet ds = ssc.GetReportTopup(Convert.ToInt32(ddlDistributor.SelectedValue), ClientTypeID, LoginID, FromDate, ToDate);
