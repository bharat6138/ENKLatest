...
<<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubscriberEasygoPortIn.aspx.cs" Inherits="ENK.SubscriberEasygoPortIn" %>
	...
	<head>
		...
		<link rel="apple-touch-startup-image" href="img/splash/iphone.png" media="screen and (max-device-width: 320px)">
         ...
         <script type="text/javascript">
            ...
            if (document.getElementById("<%=txtServiceProvider.ClientID%>").value == "") {
                     alert("Service Provide Can't be Blank");
                     document.getElementById("<%=txtServiceProvider.ClientID%>").focus();
                return false;
            }
            ...
            if (document.getElementById("<%=txtState.ClientID%>").value == "") {
                 ...
                 if (document.getElementById("<%=txtLastname.ClientID%>").value == "") {
                     alert("1st and Last Name Can't be Blank");
		...
		<div id="main" role="main">
			...
			<div id="content" class="container">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">   
                                   <h5> <label class="label  pull-right" style="color:#208ac4!important;font-size: large!important;">EASYGO PORTIN</label></h5>
                     </div>
				<div class="row">
				<%--	<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 hidden-xs hidden-sm">
						...
						<div class="hero" style="height: 150px!important;">
							<div class="pull-left login-desc-box-l">
								<h4 class="paragraph-header">SIM PORTIN</h4>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="well no-padding">
							<div  id="login-form" class="smart-form client-form">
                                ...
                                <div id="divahannel" runat="server" class="col-xs-12 col-sm-12 col-md-12 col-lg-6">             
                                ...
                                <div id="divLanguage" runat="server" class="col-xs-12 col-sm-12 col-md-12 col-lg-6">   
                                ...
                                <asp:TextBox ID="txtLastname"   title="Enter Customer 1st and Last Name" runat="server"></asp:TextBox>
                                 ...
                                 <footer class="boxBtnsubmit">
                                   <asp:Button ID="btnSubscriber" class="btn btn-primary"   runat="server"  Text="PORTIN" OnClick="btnSubscriber_Click" OnClientClick="javascript:return validateControlsActivatePort();" /> 
