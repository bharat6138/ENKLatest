...
namespace ENK
{
    public partial class DeductReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                DataSet ds = ssc.GetReportDeduct(distributorID, ClientTypeID, LoginID, FromDate, ToDate);
        ...
        protected void btnGet_Click(object sender, EventArgs e)
        {
            ...
            if (txtFromDate.Text.Trim() == "" && txtToDate.Text.Trim() == "")
            {
                ...
                DataSet ds = ssc.GetReportDeduct(Convert.ToInt32(ddlDistributor.SelectedValue), ClientTypeID, LoginID, FromDate, ToDate);
            ...
            else if (txtFromDate.Text.Trim() != "" && txtToDate.Text.Trim() != "")
            {
                ...
                {
                    ds = ssc.GetReportDeduct(DistributorID, ClientTypeID, LoginID, FromDate, ToDate);
                }
                else
                {
                    ds = ssc.GetReportDeduct(Convert.ToInt32(ddlDistributor.SelectedValue), ClientTypeID, LoginID, FromDate, ToDate);
                }
