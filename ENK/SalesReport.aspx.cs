    ...
    public partial class SalesReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    DataSet ds = ssc.GetReportSalesReport(DistributorID, ClientTypeID, LoginID, FromDate, ToDate);
        ...
        protected void btnGet_Click(object sender, EventArgs e)
        {
            ...
            if (txtFromDate.Text.Trim()=="" && txtToDate.Text.Trim()=="")
            {
                ...
                DataSet ds = ssc.GetReportSalesReport(Convert.ToInt32(ddlDistributor.SelectedValue), ClientTypeID, LoginID, FromDate, ToDate);
            ...
            else if (txtFromDate.Text.Trim() != "" && txtToDate.Text.Trim() != "")
            {
                ...
                {
                    ds = ssc.GetReportSalesReport(DistributorID, ClientTypeID, LoginID, FromDate, ToDate);//ssc.GetSaleReportForActivationAndPortIn(DistributorID, 1, FromDate, ToDate);
                }
                else
                {
                    ds = ssc.GetReportSalesReport(Convert.ToInt32(ddlDistributor.SelectedValue), ClientTypeID, LoginID, FromDate, ToDate);//ssc.GetSaleReportForActivationAndPortIn(Convert.ToInt32(ddlDistributor.SelectedValue), 0, FromDate, ToDate);
                }
                if (ds != null)
                {
                    ViewState["SIMPurchase"] = ds.Tables[0];
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            //DataSet ds = ssc.GetReportSalesReport(Convert.ToInt32(ddlDistributor.SelectedValue), 0, LoginID, FromDate, ToDate);
            DataSet ds;
            if (ddlDistributor.SelectedValue == "0")
            {
                ds = ssc.GetReportSalesReport(DistributorID, ClientTypeID, LoginID, FromDate, ToDate);//ssc.GetSaleReportForActivationAndPortIn(DistributorID, 1, FromDate, ToDate);
            ...
            if (ds != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    DataTable dtExcel = view.ToTable("Selected", false, "CustomerName", "EmailID", "Address", "UlternatMobileNumber", "SIMSerialNumber", "MobileNumber", "Distributor", "InventoryStatus", "TariffCode", "Rental", "ValidityDays", "SaleDtTm");//, "INTERNATIONAL_BUNDLE_CODE", "INTERNATIONAL_BUNDLE_AMOUNT"

                    if (dtExcel.Rows.Count > 0)
                    {
                        string filename = " SaleReportOfPOS.xls";
