...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubscriberEasygoSim.aspx.cs" Inherits="ENK.SubscriberEasygoSim" %>
		...
		<div id="main" role="main">
			...
			<div id="content" class="container">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">   
                                   <h5> <label class="label  pull-right" style="color:#208ac4!important;font-size: large!important;">ACTIVATE EASYGO SIM</label></h5>
                     </div>
				<div class="row">
						...
						<div class="well no-padding">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">   
                                   <h5> <label class="label">Hi Subscriber</label></h5>
                                    </div>
