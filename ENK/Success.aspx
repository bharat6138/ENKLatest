...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Success.aspx.cs" Inherits="ENK.Success" %>
...
<script type="text/javascript" src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>
    ...
    <script type="text/javascript">
        ...
        function JScriptConfirmationFail() {

           
            alert("Subscriber Recharge Failed !!");
                                  ...
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">  
                                    ...
                                    <asp:Label ID="lblresponse"  runat="server" Visible="false" Text=""></asp:Label>
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                            ...
                                                            <asp:HyperLink ID="lnkback" NavigateUrl="<%= ConfigurationManager.AppSettings["COMPANY_SUBSCRIBERAPPURL"] %>" Class="pull-right" runat="server">Back to Recharge</asp:HyperLink>
