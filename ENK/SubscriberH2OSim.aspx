...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubscriberH2OSim.aspx.cs" Inherits="ENK.SubscriberH2OSim" %>
		...
		<div id="main" role="main">
			...
			<div id="content" class="container">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">   
                                   <h5> <label class="label  pull-right" style="color:#208ac4!important;font-size: large!important;">ACTIVATE H2O SIM</label></h5>
                     </div>
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="well no-padding">
							<div  id="login-form" class="smart-form client-form">
                                 <asp:Label ForeColor="Green" cssClass="label pull-right" ID="Label7" runat="server" Text="Download Subscriber App from Google Play Store"></asp:Label>
                                 <asp:HyperLink id="hyperlink2"   width="99px"   CssClass="label pull-right" ImageUrl="img/playstore.png" NavigateUrl="<%= ConfigurationManager.AppSettings["COMPANY_SUBSCRIBERAPPURL"] %>"  ToolTip  ="Download Subscriber  Android App"
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">   
                                    <label class="label">SIM CARD<asp:Label ID="Label1" ForeColor="Red" runat="server" Text="*"></asp:Label></label>
                                    <label class="input">   
                                    <asp:TextBox ID="txtSIMCARD"  title="Enter your SIM card number" runat="server" MaxLength="20" onkeypress="javascript:return onlynumeric(event,this);"></asp:TextBox>                           
                                     <b class="tooltip tooltip-top-right">
                                                <i class="fa fa-arrow-circle-down"></i> Enter SIM card number</b>    
                                    </label>
                                </div>                            
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">                          
                                    <label class="label">ZIP Code<asp:Label ID="Label2" ForeColor="Red" runat="server" Text="*"></asp:Label></label>
                                    <label class="input">  
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">                                   
                                    ...
                                    <label class="input">  
                                      ...
                                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">                                   
                                    <label class="label">City<asp:Label ID="Label4" ForeColor="Red" runat="server" Text="*"></asp:Label></label>                                       
                                    <label class="input">  
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">                                   
                                    <label class="label">Address<asp:Label ID="Label5" ForeColor="Red" runat="server" Text="*"></asp:Label></label>                                       
                                    <label class="input">  
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">                                   
                                    <label class="label">Alternate Number <asp:Label ID="Label6" ForeColor="Red" runat="server" Text="*"></asp:Label></label>                                       
                                    <label class="input">  
