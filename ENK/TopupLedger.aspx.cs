...
namespace ENK
{
    public partial class TopupLedger : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            if (ds != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    DataTable dtExcel = view.ToTable("Selected", false, "AccountName", "TransactionDate", "TransactionType", "CreditFrom", "CreditAmount", "DebitAmount");//, "INTERNATIONAL_BUNDLE_CODE", "INTERNATIONAL_BUNDLE_AMOUNT"

                    if (dtExcel.Rows.Count > 0)
                    {
                        string filename = " TopupLedgerReport.xls";
