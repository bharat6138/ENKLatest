...
<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="TopupLedger.aspx.cs" Inherits="ENK.TopupLedger" %>
                        ...
                        <div class="box-input">        
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2"> 
                                    ...
                                    <asp:Button ID="btnGet" runat="server" Text="Get Report"  class="btn btn-primary" OnClick="btnGet_Click" OnClientClick="javascript:return ShowProgress();"  /> 
                                        ...
                                        <asp:Repeater ID="RepeaterTransfer" runat="server">
                                         <HeaderTemplate >
                                              ...
                                              <ItemTemplate> 
                                                <tr>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label9" text='<%# Eval("AccountName") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label5" text='<%# Eval("TransactionDate") %>' />
                                                    </td>

                                                    <td>
                                                    <asp:Label runat="server" ID="Label6" text='<%# Eval("TransactionType") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label7" text='<%# Eval("CreditFrom") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label1" text='<%# Eval("CreditAmount") %>' />
                                                    </td>  
                                                    <td>
                                                    <asp:Label runat="server" ID="Label3" text='<%# Eval("DebitAmount") %>' />
                                                    </td>
