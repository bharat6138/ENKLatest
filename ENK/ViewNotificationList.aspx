<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ViewNotificationList.aspx.cs" Inherits="ENK.ViewNotificationList" %>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <ul id="sparks" class="">
							<li class="sparks-info">
								<a href="Notification.aspx" title="New">
                                	<span><i class="fa fa-file"></i></span> Send Notification
                               	</a>
							</li>
                                    ...
                                    <div class="box-input">
                                        ...
                                        <div class="row">
                                            <div class="table-responsive">
                                                <asp:GridView ID="GridNotification" runat="server" AutoGenerateColumns="false" class="table table-hover"  OnItemCommand="GridNotification_ItemCommand" >
                                                    <Columns>
