...
<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="NotesReport.aspx.cs" Inherits="ENK.NotesReport" %>
                    ...
                    <div id="divNew" runat="server" class="col-xs-7 col-sm-5 col-md-5 col-lg-8">
						<ul id="sparks" class="">
							<li class="sparks-info">
								<a href="DistributorNotes.aspx" title="New Notes">
					...
					<div class="row" >
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                           ...
                           <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4" style ="padding-left: 18px">                                    
                            ...
                            <div class="row" id="DivMobile" runat="server">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10" style ="padding-left: 18px;padding-bottom: 11px"> 
                                       <label class="label">&nbsp;</label> 
...
<tr> 
                                                    ...
                                                    <td>
                                                    <asp:Label runat="server" ID="Label7" text='<%# Eval("Notes") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label1" text='<%# Eval("CreatedOn") %>' />
                                                    </td>  
