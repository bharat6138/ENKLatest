<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MainMaster.Master" CodeBehind="ActivationStatus.aspx.cs" Inherits="ENK.ActivationStatus" %>
                                                 ...
                                                 <div id="divBtn" runat="server" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6"> 
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                            ...
                                                            <asp:HyperLink ID="HyperLink1" NavigateUrl="~/ActivationSim.aspx" Class="pull-right" runat="server">Back to Activation</asp:HyperLink>
                                                        </div>
