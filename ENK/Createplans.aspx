<%@ Page Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Createplans.aspx.cs" Inherits="ENK.Createplans" %>
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0"  data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
								...
								<div>
                                  ...
                                  <label style="COLOR: BLACK; FONT-SIZE: 14PX;" class="label">Network</label>                             
                                    <label class="input">  
                                        
                                                    <asp:DropDownList style="WIDTH: 150PX;"  AutoPostBack="true"  ID="ddlNetwork" OnSelectedIndexChanged="ddlNetwork_SelectedIndexChanged"  runat="server">
                                              ...
                                              <ItemTemplate> 
                                                <tr>
                                                    ...
                                                    <asp:Label runat="server" ID="Label4" text='<%# Eval("ValidityDays") %>' />
                                                       ...
                                                       <td>
                                                    <asp:Label runat="server" ID="Label5" text='<%# Eval("Network") %>' />
                                                    </td>
                                                     <td>
                                                    <asp:ImageButton id="lnkView" runat="server" CausesValidation="false" ToolTip="View Plan" CommandName="View" CommandArgument='<%#Eval("ID") %>' ImageUrl="~/img/1399984583_view.png" /> &nbsp
                                                    <asp:ImageButton ID="lnkEdit"  runat="server" CausesValidation="false" ToolTip="Edit Plan" CommandName="RowEdit" CommandArgument='<%#Eval("ID") %>' ImageUrl="~/img/Pencil-icon.png"  />&nbsp
                                                    </td>
                                                </tr>          
                                              ...
                                              <ItemTemplate> 
                                                <tr>
                                                    ...
                                                    <asp:Label runat="server" ID="Label4" text='<%# Eval("ValidityDays") %>' />
                                                          ...
                                                          <td>
                                                    <asp:Label runat="server" ID="Label6" text='<%# Eval("Network") %>' />
                                                    </td>
