...
public class NVPAPICaller
{
    ...
    private string APIUser = "ENK@yahoo.com";
    //Fill in the APIPassword variable yourself, the wizard will not do this automatically
    private string APIPassword = "Vendal00!";
    private string APIVendor = "ENK@yahoo.com";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:1181/RechargeSuccess.aspx";
        string cancelURL = "http://localhost:1181/RechargeSuccess.aspx";
