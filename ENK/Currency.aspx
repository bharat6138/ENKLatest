m<%@ Page Language="C#"  MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Currency.aspx.cs" Inherits="ENK.Currency" %>
                            ...
                            <div class="row">                                
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6"> 
                                        ...
                                        <label class="input">  
                                        <asp:TextBox ID="txtCurrency" runat="server" title="Currency...."></asp:TextBox> 
                                       
                                             <b class="tooltip tooltip-top-right">
                                        <i class="fa fa-arrow-circle-down"></i> Enter Currency</b>
                                       </label>                                    
                                       </div>
