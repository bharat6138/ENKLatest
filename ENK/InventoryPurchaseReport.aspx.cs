        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    DataSet ds = ssc.GetReportInventoryPurchase(distributorID, ClientTypeID, LoginID, FromDate, ToDate);
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            if (ds != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    DataTable dtExcel = view.ToTable("Selected", false, "SIM_Status", "SIMSerialNumber", "MobileNumber", "PIN", "PUK", "SIMType", "VendorName", "PurchaseDate");//, "INTERNATIONAL_BUNDLE_CODE", "INTERNATIONAL_BUNDLE_AMOUNT"
