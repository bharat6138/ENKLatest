...
<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="RechargeFailReport.aspx.cs" Inherits="ENK.RechargeFailReport" %>
					...
					<div class="col-xs-12 col-sm-5 col-md-5 col-lg-4">
						<h1 class="page-title txt-color-blueDark">
							<i class="fa fa-lg fa-fw fa-file-text"></i> 
								Report
							<span>> 
								 Recharge Failed Report				</span>						</h1>
					</div>
					...
					<div class="row" >
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
								...
								<header>
									...
									<h2>
							<span>Recharge					</span>						&nbsp;Failed Report</h2>
								</header>
                        ...
                        <div class="box-input">
                            ...
                            <div class="row">
                                ...
                                <div   id="divSubscriber" style="display:none" >
                                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2">                                    
                                  <label class="label">Mobile Number</label>                             
                                    <label class="input">  
                                           <asp:TextBox ID="txtMobileNo" CssClass="form-control" placeholder="Mobile Number" runat="server"    ></asp:TextBox> 
                                                    

                                    </label>                                  
                                </div>
                                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">                                    
                                  <label class="label">TxnID</label>                             
                                    <label class="input">  
                                           <asp:TextBox ID="txnID"  placeholder="TxnID" CssClass="form-control"  runat="server"   ></asp:TextBox> 
                                ...
                                <asp:Button ID="btnShow"  runat="server" Text="Search"  OnClick="btnShow_Click" ToolTip="Search  Record"  class="btn btn-primary btn-sm"   />                 
                                </div>
                                </div>
                                           </div>
                           ...
                           <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2">                                    
                                  <label class="label">Recharge By</label>                             
                                    <label class="input">  
                                        
                                                    <asp:DropDownList  class="chosen-select text-area" ID="ddlRechargeVia"    runat="server">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2"> 
                                    ...
                                    <asp:Button ID="btnGet" runat="server"  class="btn btn-primary btn-xs"  Text="Get Report"  OnClick="btnGet_Click" OnClientClick="javascript:return ShowProgress();"  /> 
                                    <asp:Button ID="btnExportToExcel"  runat="server" Text="Export To Excel"  OnClick="btnExportToExcel_Click" class="btn btn-primary btn-xs"  />                 
                                </div>
                                         ...
                                         <HeaderTemplate >
                                              ...
                                              <ItemTemplate> 
                                                <tr>
                                                        ...
                                                        <asp:LinkButton ID="lnkChangeStatus"  CommandName="ChangeStatus" ToolTip="Change Status" OnClientClick="return confirm('Do you want to change status ?');"    CommandArgument='<%#Eval("RechargeID") %>' runat="server">Change Status</asp:LinkButton>
                                                    </td>
                                                    <td>
