<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="DistributorPlanMappingChange.aspx.cs" Inherits="ENK.DistributorPlanMappingChange" %>
...
<script type="text/javascript" src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>
    ...
    <script type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById("<%=ddlTariffPlan.ClientID%>").selectedIndex == 0) {
                alert("Please select Plan");
                document.getElementById("<%=ddlTariffPlan.ClientID%>").focus();
                 return false;
             }
                        ...
                        <div class="box-input">        
                           ...
                           <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">                                    
                                    ...
                                    <label class="input">  
                                         <asp:TextBox ID="txtRental" runat="server" Placeholder="Rental"></asp:TextBox>
                                    </label> 
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2"> 
                                    ...
                                    <asp:Button ID="btnDone" class="btn btn-primary" runat="server" Text="Done" Style="float: right; height: 31px;margin: 10px 0 0 5px;padding: 0 44px;margin-top:0px; font: 300 15px/29px 'Open Sans',Helvetica,Arial,sans-serif; cursor: pointer;" OnClick="btnDone_Click" OnClientClick="javascript:return validate();" />
