...
namespace ENK
{
    public partial class AndroidRecharge : System.Web.UI.Page
    {
        ...
        public void MakeReceipt(string resp)
        {
            ...
            // string redirecturl="";
            // string ss="";
            // ss=   lblTransactionAmount.Text.ToString() + "," + lblTransactionDate.Text.ToString() + "," + lblPayerName.Text.ToString() + "," + lblPayerName.Text.ToString() + "," + lblAddress.Text.ToString() ;

            //redirecturl += "Success.aspx?Success=" + ss;
