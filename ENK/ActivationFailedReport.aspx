...
<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="ActivationFailedReport.aspx.cs" Inherits="ENK.ActivationFailedReport" %>
					...
					<div class="col-xs-12 col-sm-5 col-md-5 col-lg-4">
						<h1 class="page-title txt-color-blueDark">
							<i class="fa fa-lg fa-fw fa-file-text"></i> 
								Report
							<span>> 
								 Activation Failed Report				</span>						</h1>
					</div>
					...
					<div class="row" >
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
								...
								<header>
									...
									<h2>
							<span>Activation					</span>						&nbsp;Failed Report</h2>
								</header>
                        ...
                        <div class="box-input">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2" style="display:none">                                    
                                ...
                                <asp:Button ID="btnShow"  runat="server" Text="Search"  OnClick="btnShow_Click" ToolTip="Search  Record"  class="btn btn-primary"  />                 
                                </div>
                                </div>
                                           </div>
...
<tr>
                                                   <td>
                                                      <asp:LinkButton ID="lnkChangeStatus"  CommandName="ChangeStatus" ToolTip="Change Status" OnClientClick="return confirm('Do you want to change status ?');"    CommandArgument='<%#Eval("ActivationID") %>' runat="server">Change Status</asp:LinkButton>
                                              

                                                  </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label9" text='<%# Eval("Activationstatus") %>' />
                                                    </td>
                                                    <td>
