<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="SalesReportForActivationAndPortIn.aspx.cs" Inherits="ENK.SalesReportForActivationAndPortIn" %>
                                        ...
                                        <asp:Repeater ID="RepeaterData" runat="server">
                                         <HeaderTemplate >
                                              <table class="table table-bordered"  id="dataTables-example">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Bundle Amount</th>
                                                        <th>No Of Months</th>
                                                        <%--<th>International Bundle Code</th>
                                                        <th>International Bundle Amount</th>--%>
                                                        <th>RequestDate</th>
                                                        <th>ProcessedDate</th>
                                                        <th>PinNumber</th>
                                                        <th>Topup Amount</th>
                                              ...
                                              <ItemTemplate> 
                                                <tr>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label15" text='<%# Eval("Type") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label5" text='<%# Eval("Name") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label16" text='<%# Eval("RetialerBundleAmount") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label9" text='<%# Eval("Channel Transaction ID") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label10" text='<%# Eval("ZipCode") %>' />
                                                    </td>  
                                                    <td>
                                                    <asp:Label runat="server" ID="Label12" text='<%# Eval("PaymentChannel") %>' />
                                                    </td> 
                                                    <td>
                                                    <asp:Label runat="server" ID="Label11" text='<%# Eval("ICCID") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label7" text='<%# Eval("RealMSISDN") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label1" text='<%# Eval("Bundle Code") %>' />
                                                    </td>  
                                                    <td>
                                                    <asp:Label runat="server" ID="Label3" text='<%# Eval("Bundle Amount") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label17" text='<%# Eval("No of Months") %>' />
                                                    </td>
                                                    <%--<td>
                                                    <asp:Label runat="server" ID="Label4" text='<%# Eval("International Bundle Code") %>' />
                                                    </td> 
                                                    <td>
                                                    <asp:Label runat="server" ID="Label5" text='<%# Eval("International Bundle Amount") %>' />
                                                    </td>--%>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label6" text='<%# Eval("RequestDate") %>' />
                                                    </td> 
                                                    <td>
                                                    <asp:Label runat="server" ID="Label8" text='<%# Eval("ProcessedDate") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label13" text='<%# Eval("PinNumber") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label14" text='<%# Eval("Topup Amount") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label4" text='<%# Eval("Account Number") %>' />
                                                    </td>
