...
namespace ENK
{
    public partial class ActivationSIMReport : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    if (Session["LoginId"] != null)
                    {
                        ...
                        //DataSet ds = ssc.GetReportActivationSIM(distributorID, 1, LoginID, FromDate, ToDate, checkValue);
                        //if (ds != null)
                        //{
        ...
        protected void btnGet_Click(object sender, EventArgs e)
        {
            ...
            if (chkMainDistributor.Checked == true)
            {
                checkValue = 1;
            ...
            if (txtFromDate.Text.Trim() == "" && txtToDate.Text.Trim() == "")
            {
                  ...
                  if (ddlLevel1.SelectedValue == "0")
                {
                    ...
                    ds = ssc.GetReportActivationSIM(Convert.ToInt32(DistributorID), 0, LoginID, FromDate, ToDate, checkValue, Convert.ToInt32(ddlNetwork.SelectedValue));
                }
                  else
                  {
                      // ds = ssc.GetReportActivationSIM(Convert.ToInt32(ddlDistributor.SelectedValue), 0, LoginID, FromDate, ToDate, checkValue);

                      ds = ssc.GetReportActivationSIM(Convert.ToInt32(ViewState["Dis"]), 0, LoginID, FromDate, ToDate, checkValue, Convert.ToInt32(ddlNetwork.SelectedValue));
            ...
            else if (txtFromDate.Text.Trim() != "" && txtToDate.Text.Trim() != "")
            {
                ...
                //DataSet ds = ssc.GetReportActivationSIM(Convert.ToInt32(ddlDistributor.SelectedValue), 0, LoginID, FromDate, ToDate);
                DataSet ds;
                //if (ddlDistributor.SelectedValue == "0")
                if (ddlLevel1.SelectedValue == "0")
                {
                    ds = ssc.GetReportActivationSIM(DistributorID, 1, LoginID, FromDate, ToDate, checkValue, Convert.ToInt32(ddlNetwork.SelectedValue));//ssc.GetSaleReportForActivationAndPortIn(DistributorID, 1, FromDate, ToDate);

                }
                else
                {
                   // ds = ssc.GetReportActivationSIM(Convert.ToInt32(ddlDistributor.SelectedValue), 0, LoginID, FromDate, ToDate, checkValue);//ssc.GetSaleReportForActivationAndPortIn(Convert.ToInt32(ddlDistributor.SelectedValue), 0, FromDate, ToDate);
                    ds = ssc.GetReportActivationSIM(Convert.ToInt32(ViewState["Dis"]), 1, LoginID, FromDate, ToDate, checkValue, Convert.ToInt32(ddlNetwork.SelectedValue));
                }
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            //if (ddlDistributor.SelectedValue == "0")
            //{
            //    ds = ssc.GetReportActivationSIM(DistributorID, 1, LoginID, FromDate, ToDate);//ssc.GetSaleReportForActivationAndPortIn(DistributorID, 1, FromDate, ToDate);
            //}
            //else
            //{
            //    ds = ssc.GetReportActivationSIM(Convert.ToInt32(ddlDistributor.SelectedValue), 0, LoginID, FromDate, ToDate);//ssc.GetSaleReportForActivationAndPortIn(Convert.ToInt32(ddlDistributor.SelectedValue), 0, FromDate, ToDate);
            //}
            ...
            //        DataTable dtExcel = view.ToTable("Selected", false, "SIMSerialNumber", "MobileNumber", "Distributor", "InventoryStatus", "TariffCode", "Rental", "ValidityDays", "ActivationDate");//, "INTERNATIONAL_BUNDLE_CODE", "INTERNATIONAL_BUNDLE_AMOUNT"

            //        if (dtExcel.Rows.Count > 0)
            //        {
            //            string filename = " ActivationSIMReport.xls";
            ...
            Response.AddHeader("content-disposition", "attachment;filename = ActivationSIMReport.xls");
        ...
        protected void ddlNetwork_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ddlNetwork.SelectedIndex > 1)
                {
                   ...
                   // dv.RowFilter = "VendorID = " + Convert.ToInt32(ddlNetwork.SelectedValue);
                    dv.RowFilter = "VendorID = " + Convert.ToString(ddlNetwork.SelectedItem.Text);
