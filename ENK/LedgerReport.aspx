...
<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="LedgerReport.aspx.cs" Inherits="ENK.LedgerReport" %>
                                        ...
                                        <asp:Repeater ID="RepeaterTransfer" runat="server">
                                         <HeaderTemplate >
                                              ...
                                              <ItemTemplate> 
                                                <tr>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label8" text='<%# Eval("TransactionID") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label9" text='<%# Eval("Distributor") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label5" text='<%# Eval("PaymentType") %>' />
                                                    </td>
                                                      <td>
                                                    <asp:Label runat="server" ID="Label4" text='<%# Eval("PaymentDtTm") %>' />
                                                    </td>
                                                    
                                                    <td>
                                                    <asp:Label runat="server" ID="Label6" text='<%# Eval("PaymentAmount") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label7" text='<%# Eval("PreviousBalance") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label1" text='<%# Eval("CurrentBalance") %>' />
                                                    </td>  
                                                    <td>
                                                    <asp:Label runat="server" ID="Label3" text='<%# Eval("Narration") %>' />
                                                    </td>
