<%@ Page Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="LycaRecharge.aspx.cs" Inherits="ENK.LycaRecharge" %>
...
<%--<script>
    $(document).ready(function () {      
        $('#<%=txtMonth.ClientID %>').keyup(function () {  
            if ($('#<%=txtMonth.ClientID %>').val().length != 0) {
                if ($('#<%=txtMonth.ClientID %>').val() == 0) {
