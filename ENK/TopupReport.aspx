<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="TopupReport.aspx.cs" Inherits="ENK.TopupReport" %>
                                                ...
                                                <div class="table-responsive" style="max-height: 237px; overflow-y: auto;">
                                                    ...
                                                    <asp:Repeater ID="RepeaterTransfer" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label runat="server" ID="Label7" Text='<%# Eval("CreditTo") %>' />
                                                                </td>
                                                                <td>
                                                                    <asp:Label runat="server" ID="Label9" Text='<%# Eval("DebitFrom") %>' />
                                                                </td>

                                                                <td>
                                                                    <asp:Label runat="server" ID="Label1" Text='<%# Eval("PaymentMode") %>' />
                                                                </td>
                                                                <td>
                                                                    <asp:Label runat="server" ID="Label3" Text='<%# Eval("ChargedAmount") %>' />
                                                                </td>
                                                                <td>
                                                                    <asp:Label runat="server" ID="Label4" Text='<%# Eval("paymentdate") %>' />
                                                                </td>
                                                                  <td>
                                                                    <asp:Label runat="server" ID="Label5" Text='<%# Eval("Remarks") %>' />
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
