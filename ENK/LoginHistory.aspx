...
<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="LoginHistory.aspx.cs" Inherits="ENK.LoginHistory" %>
                                        ...
                                        <asp:Repeater ID="RepeaterTransfer" runat="server" >
                                         <HeaderTemplate >
                                              ...
                                              <ItemTemplate> 
                                                <tr>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label9" text='<%# Eval("Distributor") %>' />
                                                    </td>
                                                    <td>
                                               <%--      <asp:HiddenField ID="hdnPurchaseID" runat="server" Value='<%# Bind("PurchaseID") %>' />--%>
                                                    <asp:Label runat="server" ID="Label7" text='<%# Eval("UserName") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label1" text='<%# Eval("IpAddress1") %>' />
                                                    </td> 
                                                     <td>
                                                    <asp:Label runat="server" ID="Label8" text='<%# Eval("Browser") %>' />
                                                    </td> 
                                                    <td>
                                                    <asp:Label runat="server" ID="Label3" text='<%# Eval("Browser1") %>' />
                                                    </td>
                                                    <td>
                                                    <asp:Label runat="server" ID="Label4" text='<%# Eval("Location") %>' />
                                                    </td> 
                                                     <td>
                                                    <asp:Label runat="server" ID="Label5" text='<%# Eval("LoginTime") %>' />
                                                    </td> 
                                                    <%--<td>
                                                    <asp:Label runat="server" ID="Label10" text='<%# Eval("BrowserDetail") %>' />
                                                    </td> --%>
