...
namespace ENK
{
    public partial class RechargeFailReport : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    if (Session["LoginId"] != null)
                    {
                        ...
                        DataSet ds = ssc.GetRechargeFailReport(distributorID, 1, LoginID, FromDate, ToDate, Convert.ToString(ddlRechargeVia.SelectedItem.Text));
        ...
        protected void btnGet_Click(object sender, EventArgs e)
        {
            ...
            if (txtFromDate.Text.Trim() == "" && txtToDate.Text.Trim() == "")
            {
                ...
                ToDate = DateTime.Now;
                int distributorID = Convert.ToInt32(Session["DistributorID"]);
                //   DataSet ds1 = ssc.GetRechargeFailReport(distributorID, 1, LoginID, FromDate, ToDate);
                DataSet ds = ssc.GetRechargeFailReport(Convert.ToInt32(ddlDistributor.SelectedValue), ClientTypeID, LoginID, FromDate, ToDate, Convert.ToString(ddlRechargeVia.SelectedItem.Text));
            ...
            else if (txtFromDate.Text.Trim() != "" && txtToDate.Text.Trim() != "")
            {
                ...
                {
                    ds = ssc.GetRechargeFailReport(DistributorID, ClientTypeID, LoginID, FromDate, ToDate, Convert.ToString(ddlRechargeVia.SelectedItem.Text));//ssc.GetSaleReportForActivationAndPortIn(DistributorID, 1, FromDate, ToDate);

                }
                else
                {
                    ds = ssc.GetRechargeFailReport(Convert.ToInt32(ddlDistributor.SelectedValue), ClientTypeID, LoginID, FromDate, ToDate, Convert.ToString(ddlRechargeVia.SelectedItem.Text));//ssc.GetSaleReportForActivationAndPortIn(Convert.ToInt32(ddlDistributor.SelectedValue), 0, FromDate, ToDate);
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            if (ddlDistributor.SelectedValue == "0")
            {
                ds = ssc.GetRechargeFailReport(DistributorID, 1, LoginID, FromDate, ToDate, Convert.ToString(ddlRechargeVia.SelectedItem.Text));//ssc.GetSaleReportForActivationAndPortIn(DistributorID, 1, FromDate, ToDate);
            }
            else
            {
                ds = ssc.GetRechargeFailReport(Convert.ToInt32(ddlDistributor.SelectedValue), 0, LoginID, FromDate, ToDate, Convert.ToString(ddlRechargeVia.SelectedItem.Text));//ssc.GetSaleReportForActivationAndPortIn(Convert.ToInt32(ddlDistributor.SelectedValue), 0, FromDate, ToDate);
            }
            ...
            if (ds != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        string filename = "FailedRechargeReport.xls";
